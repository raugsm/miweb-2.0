...
MASTER_STAGES: tuple[Stage, ...] = (
    ...
    Stage("7", "Cabin Authority", "closed_cabin_reality_authority", "workspace"),
...
LAYERS: tuple[Layer, ...] = (
    ...
    Layer("Cabin Reality Authority", "C#/.NET", "Own Edge/Chrome/Firefox WhatsApp preparation, visible/fresh/actionable truth and safe browser launch without closing operator sessions.", "cabin_authority_state"),
    ...
    Layer("Support & Telemetry Core", "Python + .NET", "Own local-first observability, blackbox retention, safe support bundles, trace correlation and privacy-preserving diagnostics across the IA operator.", "support_telemetry_state"),
