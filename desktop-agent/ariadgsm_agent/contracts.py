...
CONTRACT_FILES: dict[str, str] = {
    ...
    "event_backbone_state": "event-backbone-state.schema.json",
    "timeline_state": "timeline-state.schema.json",
    ...
    "window_lifecycle_event": "window-lifecycle-event.schema.json",
...
SAMPLE_EVENTS: dict[str, dict[str, Any]] = {
    ...
    "evaluation_release_state": {
        ...
        "gates": [
            ...
            },
            {
                ...
                "status": "ok",
                "score": 1.0,
                "summary": "Panel local y Cloud Sync tienen controles web minimos validados.",
            },
        ],
        "summary": {
            "gatesTotal": 8,
    ...
    "window_lifecycle_event": {
        "schemaVersion": "1.0",
        "eventType": "channel_window_lost",
        "eventId": "window-life-wa-3-sample",
        "observedAt": utc_now(),
        "channelId": "wa-3",
        "browserProcess": "firefox",
        ...
        "previousWindow": {
            ...
            "processId": 492,
            "processName": "firefox",
            "title": "WhatsApp Business - Mozilla Firefox",
            "bounds": {"left": 1280, "top": 0, "width": 640, "height": 900},
        },
        "currentWindow": {
            "status": "missing",
            "handle": "",
        ...
        "summary": "wa-3: perdi la ventana visible de firefox; no actuo hasta recuperarla.",
    },
    "vision_event": {
    ...
    "reader_core_state": {
        ...
        "outputFiles": {
            ...
            "checkpoint": "desktop-agent/runtime/event-backbone-state.json",
        },
        "ingested": {
            "sourceEvents": 1,
            "candidateMessages": 1,
        ...
        "backbone": {
            ...
            "version": "0.9.9",
            "mode": "incremental_offset_tail",
            "namespace": "reader_core_sources",
            "checkpointFile": "desktop-agent/runtime/event-backbone-state.json",
            "cycleMs": 12,
            "limit": 500,
            "sources": [],
            "summary": {
            ...
            "cycleDurationMs": 12,
            "compactions": [],
            "humanSummary": "Lei 4096 bytes incrementales; backlog=0; saltado=0; ciclo=12ms.",
        },
        "channels": [
            {
                "channelId": "wa-1",
    ...
    "event_backbone_state": {
        ...
        "updatedAt": utc_now(),
        "sources": {
            "reader_core_sources:c:/ariadgsm/runtime/perception-events.jsonl": {
                "path": "c:/ariadgsm/runtime/perception-events.jsonl",
                "namespace": "reader_core_sources",
                "offset": 4096,
                "fileSize": 4096,
                "lastReadAt": utc_now(),
                ...
                "bytesRead": 2048,
                "skippedBacklogBytes": 0,
                "resetReason": "first_read",
                "partialLineHeld": False,
            }
        },
        "latestBatch": {
            "engine": "ariadgsm_event_timeline_durable_backbone",
    ...
    "timeline_state": {
        ...
        "version": "0.9.9",
        "updatedAt": utc_now(),
        "conversationEventsFile": "desktop-agent/runtime/conversation-events.jsonl",
        "historyEventsFile": "",
        "timelineEventsFile": "desktop-agent/runtime/timeline-events.jsonl",
        "db": "desktop-agent/runtime/timeline.sqlite",
        "checkpointFile": "desktop-agent/runtime/event-backbone-state.json",
        "historyLimitDays": 30,
        "replaceOutput": True,
        "ingested": {
        ...
        "latestTimelines": [
            {
                "conversationEventId": "timeline-wa-1-sample",
