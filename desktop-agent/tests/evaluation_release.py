...
def make_release_repo(root: Path) -> None:
    ...
    manifest = {
        "version": "0.9.0",
        "packageUrl": "https://raw.githubusercontent.com/raugsm/miweb-2.0/main/desktop-agent/update/releases/AriadGSMAgent-0.9.0.zip",
...
def main() -> int:
    ...
    with TemporaryDirectory() as repo_tmp, TemporaryDirectory() as runtime_tmp:
        ...
        state = run_evaluation_release_once(repo, runtime, version="0.9.0")
