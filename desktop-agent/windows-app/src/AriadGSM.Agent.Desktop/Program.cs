...
internal static class Program
{
    ...
    private static int RunSelfTest()
    {
        ...
        var requiredFiles = new[]
        {
            ...
            Path.Combine("desktop-agent", "ariadgsm_agent", "__init__.py"),
            Path.Combine("desktop-agent", "contracts", "reader-core-state.schema.json"),
            Path.Combine("desktop-agent", "contracts", "window-reality-state.schema.json"),
            "server-wrapper.js",
            Path.Combine("public", "operativa-v2.html"),
